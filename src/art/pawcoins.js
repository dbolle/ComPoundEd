// PAW BUCKS coin art — the app's own fictional currency, the money a child
// EARNS. Split out of src/art/coins.js in v1.55.0, which now holds drawn
// representations of real US currency for the Money Math track.
//
// The two must not merge again. They mean different things:
//   • Paw Bucks (this file) are FICTITIOUS FOREVER (CHARTER.md) — earned by
//     learning, spent in the Pet Store, never real money. Paw print, paw
//     names ("Paw Dime"), face value printed, because a made-up coin has no
//     real-world design a child could otherwise read.
//   • US currency (coins.js) is what a child STUDIES (2.MD.8). Real designs,
//     real names, no printed value — a real coin does not carry one, and a
//     numeral would answer wave 1's "which coin is this?" for them.
//
// Consumers today draw CSS discs (wallet, store, cointray); BACKLOG lists
// adopting this art for them. Keeping it here means that work still has art
// to adopt.
//
// Originally v1.52.0. One face per `DENOMS` id in
