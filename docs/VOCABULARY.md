...
Two registers. Every new string picks one and sticks to its column.
(Enforced by tests/vocab.spec.js; added v1.9.0.)
...
| an animal's sound | its own word — **barks / meows / thumps / squeaks / chirps / sighs / snuffles / hums / oinks** (never "barks" for a cat) | per-species voice |
