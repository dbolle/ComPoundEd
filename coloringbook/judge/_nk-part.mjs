const A = await import('/tmp/claude-1000/-home-USER-compounded/50ad3f5d-491c-4745-97b9-38751da704e7/scratchpad/base89f/src/art/coins.js');
const B = await import('/home/USER/compounded/src/art/coins.js');
const IDS=['penny','nickel','dime','quarter','buck'], SIDES=['obverse','reverse'];
const SZ=[26,38,42,44,48,54,62,84,110,190,380];
